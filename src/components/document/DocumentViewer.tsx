...
const OverviewIcon = ({ className }: IconProps) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" width="17" height="16" viewBox="0 0 17 16" fill="none">
    <path d="M11.8333 4.06641H2.5" stroke="#18181B" stroke-width="1.33" stroke-linecap="round" stroke-linejoin="round"/>
...
const DetailedIcon = ({ className }: IconProps) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
    <path d="M14 10C14 10.3536 13.8595 10.6928 13.6095 10.9428C13.3594 11.1929 13.0203 11.3333 12.6667 11.3333H4.66667L2 14V3.33333C2 2.97971 2.14048 2.64057 2.39052 2.39052C2.64057 2.14048 2.97971 2 3.33333 2H12.6667C13.0203 2 13.3594 2.14048 13.6095 2.39052C13.8595 2.64057 14 2.97971 14 3.33333V10Z" stroke="#18181B" stroke-width="1.33" stroke-linecap="round" stroke-linejoin="round"/>
    <path d="M8.66699 5.33398H4.66699" stroke="#18181B" stroke-width="1.33" stroke-linecap="round" stroke-linejoin="round"/>
...
const NotesIcon = ({ className }: IconProps) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
    <path d="M9.99935 1.33398H3.99935C3.64573 1.33398 3.30659 1.47446 3.05654 1.72451C2.80649 1.97456 2.66602 2.3137 2.66602 2.66732V13.334C2.66602 13.6876 2.80649 14.0267 3.05654 14.2768C3.30659 14.5268 3.64573 14.6673 3.99935 14.6673H11.9993C12.353 14.6673 12.6921 14.5268 12.9422 14.2768C13.1922 14.0267 13.3327 13.6876 13.3327 13.334V4.66732L9.99935 1.33398Z" stroke="#18181B" stroke-width="1.33" stroke-linecap="round" stroke-linejoin="round"/>
    <path d="M9.33398 1.33398V4.00065C9.33398 4.35427 9.47446 4.69341 9.72451 4.94346C9.97456 5.19351 10.3137 5.33398 10.6673 5.33398H13.334" stroke="#18181B" stroke-width="1.33" stroke-linecap="round" stroke-linejoin="round"/>
  </svg>
)
...
const ChatIcon = ({ className }: IconProps) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
    <g clip-path="url(#clip0_2294_15017)">
      <path d="M8.00065 4.00065V1.33398H5.33398" stroke="black" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
      <path d="M5.33268 12L2.66602 14.6667V5.33333C2.66602 4.97971 2.80649 4.64057 3.05654 4.39052C3.30659 4.14048 3.64573 4 3.99935 4H11.9993C12.353 4 12.6921 4.14048 12.9422 4.39052C13.1922 4.64057 13.3327 4.97971 13.3327 5.33333V10.6667C13.3327 11.0203 13.1922 11.3594 12.9422 11.6095C12.6921 11.8595 12.353 12 11.9993 12H5.33268Z" stroke="black" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
...
const RotateIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="19" height="18" viewBox="0 0 19 18" fill="none">
    <path d="M2.375 9C2.375 10.335 2.79287 11.6401 3.57578 12.7501C4.35868 13.8601 5.47146 14.7253 6.77338 15.2362C8.0753 15.7471 9.5079 15.8808 10.89 15.6203C12.2721 15.3599 13.5417 14.717 14.5381 13.773C15.5346 12.829 16.2132 11.6262 16.4881 10.3169C16.763 9.00749 16.6219 7.65029 16.0826 6.41689C15.5434 5.18349 14.6301 4.12928 13.4584 3.38758C12.2867 2.64588 10.9092 2.25 9.5 2.25C7.50813 2.2571 5.59627 2.99342 4.16417 4.305L2.375 6" stroke="black" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
...
const PasteIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="19" height="18" viewBox="0 0 19 18" fill="none">
    <g clip-path="url(#clip0_2294_15075)">
        <path d="M15.834 6H7.91732C7.04287 6 6.33398 6.67157 6.33398 7.5V15C6.33398 15.8284 7.04287 16.5 7.91732 16.5H15.834C16.7084 16.5 17.4173 15.8284 17.4173 15V7.5C17.4173 6.67157 16.7084 6 15.834 6Z" stroke="black" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
        <path d="M3.16732 12C2.29648 12 1.58398 11.325 1.58398 10.5V3C1.58398 2.175 2.29648 1.5 3.16732 1.5H11.084C11.9548 1.5 12.6673 2.175 12.6673 3" stroke="black" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
    </g>
    <defs>
...
const SaveIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="19" height="18" viewBox="0 0 19 18" fill="none">
        <path d="M12.0333 2.25C12.451 2.25564 12.8493 2.41738 13.1417 2.7L16.15 5.55C16.4483 5.82695 16.6191 6.20435 16.625 6.6V14.25C16.625 14.6478 16.4582 15.0294 16.1613 15.3107C15.8643 15.592 15.4616 15.75 15.0417 15.75H3.95833C3.53841 15.75 3.13568 15.592 2.83875 15.3107C2.54181 15.0294 2.375 14.6478 2.375 14.25V3.75C2.375 3.35218 2.54181 2.97064 2.83875 2.68934C3.13568 2.40804 3.53841 2.25 3.95833 2.25H12.0333Z" stroke="black" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
        <path d="M13.4577 15.75V10.5C13.4577 10.3011 13.3743 10.1103 13.2258 9.96967C13.0773 9.82902 12.876 9.75 12.666 9.75H6.33268C6.12272 9.75 5.92136 9.82902 5.77289 9.96967C5.62442 10.1103 5.54102 10.3011 5.54102 10.5V15.75" stroke="black" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
        <path d="M5.54102 2.25V5.25C5.54102 5.44891 5.62442 5.63968 5.77289 5.78033C5.92136 5.92098 6.12272 6 6.33268 6H11.8743" stroke="black" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
);
...
const AtSignIcon = () => (
  ...
  <g clip-path="url(#clip0_2294_15042)">
    <path d="M6.99935 9.33268C8.28801 9.33268 9.33268 8.28801 9.33268 6.99935C9.33268 5.71068 8.28801 4.66602 6.99935 4.66602C5.71068 4.66602 4.66602 5.71068 4.66602 6.99935C4.66602 8.28801 5.71068 9.33268 6.99935 9.33268Z" stroke="black" stroke-linecap="round" stroke-linejoin="round"/>
    <path d="M9.33269 4.66602V7.58269C9.33269 8.04682 9.51706 8.49194 9.84525 8.82012C10.1734 9.14831 10.6186 9.33269 11.0827 9.33269C11.5468 9.33269 11.9919 9.14831 12.3201 8.82012C12.6483 8.49194 12.8327 8.04682 12.8327 7.58269V6.99935C12.8327 5.68528 12.389 4.4097 11.5735 3.37929C10.758 2.34887 9.6185 1.62398 8.33958 1.32207C7.06066 1.02016 5.71727 1.15891 4.52705 1.71584C3.33684 2.27278 2.36954 3.21527 1.78186 4.39061C1.19419 5.56595 1.02058 6.90529 1.28916 8.19162C1.55775 9.47795 2.25278 10.6359 3.26166 11.4779C4.27054 12.3199 5.53416 12.7966 6.84779 12.8307C8.16142 12.8649 9.4481 12.4545 10.4994 11.666" stroke="black" stroke-linecap="round" stroke-linejoin="round"/>
  </g>
  <defs>
          ...
          <div className="flex items-center w-full mx-2 mt-2">
            ...
            >
              ...
              <div className="h-[calc(100vh-130px)] overflow-hidden">
                ...
                <TabsContent 
                  value="notes" 
                  className="h-full flex flex-col mt-0 data-[state=inactive]:hidden"
                >
                ...
                >
                        ...
                        <>
                          ...
                          <div className="flex items-start space-x-3">
                            ...
                            <div className="flex-1">
                              ...
                              <div className="flex h-[79px] min-h-[60px] p-2 px-3 items-start gap-[10px] flex-shrink-0 self-stretch rounded-md border border-[#E4E4E7] bg-[#FCFBFC] shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)] text-sm text-gray-600">
                                Type a message for me to help you out with reviewing this document, provide valuable information and things beyond that.
                              </div>
                          ...
                          {messages.map((message, i) => (
                            <div key={i} className="flex items-start space-x-3">
                              <div className={`w-8 h-8 rounded-full ${message.role === 'assistant' ? 'bg-[#E6E8EF]' : 'bg-[#C2DEC0]'} flex items-center justify-center flex-shrink-0`}>
                                <span className={`${message.role === 'assistant' ? 'text-sm font-medium' : 'text-[9px] font-bold'}`} style={{
                              ...
                              <div className="flex-1">
                                <div className="font-medium mb-2" style={{
                                  ...
                                  lineHeight: '100%',
                                  alignSelf: 'stretch'
                                }}>{message.role === 'assistant' ? 'AI Assistant' : user?.name}</div>
                  ...
                  {isIndexBuilt && (
                    <div className="px-2 py-2 mt-auto">
                      <div className="border rounded-lg px-5 py-2 flex flex-col" style={{
