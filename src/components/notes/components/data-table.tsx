                ...
                {showSkeleton
                  ...
                  ? table.getRowModel().rows.map((row, index) => {
                      return (
                        <Card
                          key={index}
                          className={`shadow-none border border-gray-200 transition-all duration-300 ease-in-out group opacity-100 border-l-4 hover:bg-slate-50`}
                          style={{
                            borderLeftColor: (row.original as any).highlightColor || "transparent",
                          }}
                        >
                                ...
                                <div className="flex items-center justify-between">
                                  <div className="flex flex-col items-start">
                                    ...
                                    <span className="text-xs font-medium text-gray-500 mt-0.5">
                                      {formatTime((row.original as any).createdAt)}
                                    </span>
                                  </div>
